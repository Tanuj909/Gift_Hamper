  ...
  return (
    <div className="pt-20 pb-20 min-h-screen flex flex-col">
      ...
      <Container id="contact-section" className="mt-20 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.82fr_1fr] gap-8 items-stretch">
          <div className="bg-[#FAF4E8]/85 backdrop-blur-sm border border-primary/5 rounded-2xl shadow-soft p-6 sm:p-8">
            <SectionTitle
              title="Contact Form"
